...
if(loginUser!=null){
    ...
    isSuperManager=loginUser.isSuperManager();
    isManager=loginUser.isManager();
    isTeacher=loginUser.isTeacher();
    isStudent=loginUser.isStudent();
            ...
            <div id="app-header">
                ...
                <div id="header-main">
                        <div id="topInfoPanel" style="float:left;padding-bottom: 4px">
                                <div id="welcomeMsg">欢迎[ <%=realName%> | <%=roleName%> ]登录系统</div>
