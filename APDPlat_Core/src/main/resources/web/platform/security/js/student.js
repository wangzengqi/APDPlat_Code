...
//roleId==-1或roleId<0代表为根节点，不加过滤条件
    ...
    CreateModel = function() {
        return {
            ...
            show: function() {
                CreateBaseModel.show('添加学员', 'user', 800, 460, this.getItems());
            }
        };
    } ();
    //修改模型信息
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
                ...
                ModifyBaseModel.show('修改学员', 'user', 800, 410, this.getItems(model),model);
            }
        };
    } ();
    ...
    GridModel = function() {
        return {
            ...
            getGrid: function(){
                ...
                var tips=['增加学员(C)','删除学员(R)','修改学员(U)','导出学员(E)',"重置密码(Z)"];
