...
//roleId==-1或roleId<0代表为根节点，不加过滤条件
    ...
    CreateModel = function() {
        return {
            ...
            show: function() {
                CreateBaseModel.show('添加教师', 'user', 800, 460, this.getItems());
            }
        };
    } ();
    //修改模型信息
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
                ...
                ModifyBaseModel.show('修改教师', 'user', 800, 410, this.getItems(model),model);
            }
        };
    } ();
    ...
    GridModel = function() {
        return {
            ...
            getGrid: function(){
                ...
                var tips=['增加教师(C)','删除教师(R)','修改教师(U)','导出教师(E)',"重置密码(Z)"];
